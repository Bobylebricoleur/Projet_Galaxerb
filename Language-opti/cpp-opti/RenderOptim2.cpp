...
//
//
RenderOptim2::RenderOptim2( struct galaxy g ) : galaxie( g )
{
...
//
//
RenderOptim2::RenderOptim2( Galaxy& g ) : galaxie( g )
{
...
//
//
Galaxy* RenderOptim2::particules()
{
    return &galaxie;
}
//
