...
addpath(fileparts(mfilename('RenderNaive.m')));
addpath(fileparts(mfilename('Galaxy.m')));
...
filename = "/home/alexandre/Documents/Projet_Galaxerb/data/dubinski_colored.tab";
